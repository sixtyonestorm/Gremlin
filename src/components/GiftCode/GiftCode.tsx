...
const GiftKey: React.FC = () => {
  ...
  return (
    <div className="relative">
      <div
        className="fixed top-[150px] right-4 flex flex-col items-center cursor-pointer z-50"
      ...
      >
        ...
        <span className="text-white text-xs font-bold mt-[-2px] text-shadow-md">SurpriseBox</span> {/* Hediye kodu adı */}
      </div>
